        ...
        <>
            <div className='skillsandprojects-container'>
                ...
                <div className="skillsandprojects-text">
                    ...
                    <p>
                    Among my other projects is <span className={hoveredSkill === 'CodeBrewCafe' ? 'highlight' : ''}>CodeBrewCafe </span> which is a <span className={hoveredSkill === 'CodeBrewCafe' ? 'highlight' : ''}> compilation of smaller mini-projects and widgets </span> that act as tangible products from my ongoing coding journey. My most recent project is <span className={hoveredSkill === 'RecipeRumble' ? 'highlight' : ''}>RecipeRumble </span> which is a <span className={hoveredSkill === 'RecipeRumble' ? 'highlight' : ''}>Java-written, text based adventure game</span> that I created from my personal studies to practice object-oriented programming (OOP) and to familiarize myself with a new programming language through personal study.
                    </p>
